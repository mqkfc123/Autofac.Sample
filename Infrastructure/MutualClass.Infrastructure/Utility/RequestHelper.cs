...
namespace Auth.Infrastructure.Utility
{
    public class RequestHelper
    {
        ...
        public static string GetFullHost()
        {
            ...
            if (!request.Url.IsDefaultPort && !new[] { 81 }.Any(a => a == request.Url.Port))
        ...
        /// </summary>
        /// <param name="_value">传入的值</param>
        /// <remarks>如果没有获取到 默认值为0</remarks>
        /// <returns>返回整型</returns>
        public static int GetInputInt32(string _value)
        {
            return GetInputInt32(_value, 0);
        }
        ...
        /// </summary>
        /// <param name="queryItem">页面请求的参数名称</param>
        /// <remarks>如果没有获取到 返回默认值0</remarks>
        /// <returns></returns>
        public static int GetQueryInt32(string queryItem)
        {
            return GetQueryInt32(queryItem, 0);
        }
        ...
        /// <returns></returns>
        public static string GetFormString(string queryItem, bool filterSQL, bool isHtmlEncode)
        {
            string _str = HttpContext.Current.Request.Form[queryItem];
            if (string.IsNullOrEmpty(_str))
                return "";
            ...
            if (isHtmlEncode)
                _str = StringHelper.HtmlEncode(_str);

            if (filterSQL)  //过滤SQL注入            
                _str = StringHelper.SqlFilter(_str);
        ...
        /// </summary>
        /// <param name="queryItem">页面请求的参数名称</param>
        /// <remarks>如果没有获取到 返回该默认值0</remarks>
        /// <returns>返回整型</returns>
        public static int GetFormInt32(string queryItem)
        {
            return GetFormInt32(queryItem, 0);
        }
